    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <Label htmlFor="terms" className="text-sm leading-relaxed cursor-pointer">
              I have read and understand the Submission Agreement for Binding Arbitration.
              I agree to be bound by its terms, including the{' '}
              <a
        ...
        <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-900 dark:bg-amber-950">
          ...
          <div className="text-sm text-amber-800 dark:text-amber-200">
            ...
            <p className="mt-1 text-amber-700 dark:text-amber-300">
              Once signed, this agreement cannot be revoked. The arbitration award will be
              final and binding. If you have any concerns, please consult with a legal
        ...
        <p className="text-xs text-center text-muted-foreground">
          Your signature will be recorded with timestamp, IP address, and device information
          for legal purposes.
        </p>
      </CardContent>
    </Card>
